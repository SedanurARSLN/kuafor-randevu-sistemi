...
export class AppointmentRepository implements IAppointmentRepository {
    ...
    async create(
        ...
        const query = `
            ...
            (customer_id, provider_id, service_id, appointment_date, start_time, end_time, notes)
            VALUES ($1, $2, $3, $4, $5, $6, $7)
            RETURNING *
        `;
        const values = [customerId, providerId, serviceId, appointmentDate, startTime, endTime, notes || null];
